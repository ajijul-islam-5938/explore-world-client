...
const TouriestSpots = () => {
  ...
  return (
    <div className="container mx-auto px-1 py-8">
      <h1 className="text-3xl font-bold my-10 text-center">Explore Beautiful Destinations</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
        {spots.map((spot) => (
          ...
          />
          <div className="p-6">
            <h2 className="text-xl font-semibold text-zinc-800 dark:text-white mb-4">{spot.spotName}</h2>
            <ul className="space-y-1 text-base text-zinc-700 dark:text-zinc-300 mb-4">
              ...
              <li>
                <strong>Estimated Visitors Per Year:</strong> {spot.totalVisitorsPerYear}
              </li>
            </ul>
